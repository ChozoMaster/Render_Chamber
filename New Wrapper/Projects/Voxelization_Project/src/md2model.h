...
//	Eigen::Vector3f    verts[1];       // first vertex of this frame
//
//} frame_t;
//
...
//private:
//	unsigned int uiModelVAO;
//	
//	vector<unsigned int> uiFramesBuffer;
//
//	md2_t header;
//	
//	vector< vector<Eigen::Vector3f> > vVertices; // Vertices extracted for every frame
