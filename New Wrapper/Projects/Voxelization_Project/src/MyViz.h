...
public:
	...
	v3f_list               m_dragon_vertices, m_bunny_vertices, m_xyzDragon_vertices, m_HappyStatue_vertices, m_ThaiStatue_vertices, m_cornellBox_vertices;
	v3f_list               m_dragon_normals, m_bunny_normals, m_xyzDragon_normals, m_HappyStatue_normals, m_ThaiStatue_normals, m_cornellBox_normals;
	v3f_list               m_colors;
	...
	v3f_list               m_voxel_vertices, m_TestMesh1_vertices, m_TestMesh2_vertices, m_TestMesh3_vertices, m_cubeVertices;
	v3f_list               m_TestMesh1_normals, m_TestMesh2_normals, m_TestMesh3_normals;
	...
	void drawFPS();
	void calculateFPS();
	//void draw_volume(GLsizei nf, v3f_list m_colors, v3f_list m_cubeVertices);
	void draw_volume(GLsizei nf, v3f_list m_colors, v3f_list m_cubeVertices, Eigen::Matrix4f transformMatrix);
