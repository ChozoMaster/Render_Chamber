...
namespace Utility{
static void set_vertex_normals_from_triangle_mesh(v3f_list& vertices, std::vector<std::array<unsigned int, 3> >& faces, v3f_list& normals)
	{
...
static void add_Floor(v3f_list& vertices, std::vector<std::array<unsigned int, 3> >& faces, v3f_list& normals)
	{
		float size = 5.0;
		float z = -0.45;
...
static void add_Room(v3f_list& vertices, std::vector<std::array<unsigned int, 3> >& faces, v3f_list& normals)
{
...
static void create_cube(v3f_list& vertices, std::vector<std::array<unsigned int, 3> >& faces, v3f_list& normals, float size)
{
...
static void generateTestMesh2(v3f_list& vertices, std::vector<std::array<unsigned int, 3> >& faces, v3f_list& normals)
	{
		vertices.resize(8);
...
static void generateTestMesh3(v3f_list& vertices, std::vector<std::array<unsigned int, 3> >& faces, v3f_list& normals)
	{
		vertices.resize(8);
...
static void generateVoxelVertices(v3f_list& vertices, v3f_list& colors)
	{
			colors.resize(24);
			vertices.resize(24);
