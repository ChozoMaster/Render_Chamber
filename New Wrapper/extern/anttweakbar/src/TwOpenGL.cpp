...
//#endif
    ...
    if( _glActiveTextureARB )
    {
        ...
        GLint maxTexUnits = 1;
		_glGetIntegerv(GL_MAX_TEXTURE_UNITS_ARB, &maxTexUnits); // was GL_MAX_TEXTURE_UNITS_ARB or GL_MAX_TEXTURE_COORDS
        if( maxTexUnits<1 ) 
            maxTexUnits = 1;
...
void CTwGraphOpenGL::EndDraw()
{
    ...
    {
        GLint maxTexUnits = 1;
		_glGetIntegerv(GL_MAX_TEXTURE_UNITS_ARB, &maxTexUnits); // was GL_MAX_TEXTURE_UNITS_ARB , GL_MAX_TEXTURE_COORDS
        if( maxTexUnits<1 ) 
            maxTexUnits = 1;
        else if( maxTexUnits > MAX_TEXTURES )
            maxTexUnits = MAX_TEXTURES;
